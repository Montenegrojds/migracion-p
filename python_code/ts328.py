...
modulo = "/ts"
programa = "/DepositoEfectivo"
servicio = 'ts328'
funcion = 'main'
#############################################################


class RegistrarDepositoEfectivo(BaseSchema):
...
############################################
# ALTA DE REGISTROS
# REGISTRA DEPOSITO EFECTIVO
############################################
@app.route(modulo + programa + '/Registrar', methods=["POST"])
@auth_decorator()
@required_params(RegistrarDepositoEfectivo())
def f1000_altas_ts328():
    resultado = {
...
#########################################
# MODIFICACION DEPOSITO EFECTIVO
#########################################
class ModificarDepositoEfectivo(BaseSchema):
    unidadNegocio = fields.Integer(required=True)
    codigoBanco = fields.Integer(required=True)
    numeroCuenta = fields.String(required=True)
...
@auth_decorator()
@required_params(ModificarDepositoEfectivo())
def f2000_modificar_ts328():
    resultado = {
...
class EliminarDepositoEfectivo(BaseSchema):
    unidadNegocio= fields.Integer(required=True)
    codigoBanco = fields.Integer(required=True)
    numeroCuenta = fields.String(required=True)

####################################################
# BORRAR REGISTROS DEPOSITO EFECTIVO
####################################################
@app.route(modulo + programa + '/Eliminar', methods=["DELETE"])
@auth_decorator()
@required_params(EliminarDepositoEfectivo())
def f3000_borrar_ts328():
    ...
    try:
        ...
        if rsp_delete == 0:
            ...
            print('f3000_borrar_ts328 mensaje: ', mensaje)
...
@auth_decorator()
def f5000_buscar_registro_ts328():
    result = {
        'mensaje': 'Procesado correctamente',
        'status': 200
    }
    funcion = 'f5000_buscar_registro_ts328'
...
@auth_decorator()
def f5010_buscar_gbcon_ts328():
    result = {
        'mensaje': 'Procesado correctamente',
        'status': 200
    }
    funcion = 'f5010_buscar_gbcon_ts328'
    ...
    try:
        ...
        if rsp_gbcon is None:
            ...
            result['depositoEfectivoGbcon'] = array
            result['total'] = len(array)
            result['mensaje'] = "Cargado Correctamente"
...
@auth_decorator()
def f5010_buscar_gbhtc_ts328():

    result = {
        'mensaje': 'Procesado correctamente',
        'status': 200
    }
    funcion = 'f5010_buscar_gbhtc_ts328'
...
@auth_decorator()
def f5030_buscar_tscha_ts328():
    #Trae todos los campos de la tabla Tsccb Cuentas en Bancos, puedes filtrar por numeroBanco y numeroCuenta
    result = {
        'mensaje': 'Procesado correctamente',
        'status': 200
    }
    funcion = 'f5030_buscar_tscha_ts328'
    try:
        numeroBanco = None
        numeroCuenta = None
        numeroCheque = None
...
@auth_decorator()
def f5050_buscar_cnune_ts328():
    #Trae todos los campos de la tabla Adhuu Cuentas en Bancos, puedes filtrar por numeroBanco y numeroCuenta
    result = {
        'mensaje': 'Procesado correctamente',
        'status': 200
    }
    funcion = 'f5050_buscar_cnune_ts328'
    try:
        unidadNegocio = None
        descripcion = None
...
@auth_decorator()
def f5100_buscar_detalle_ts328():

    result = {
        'mensaje': 'Procesado correctamente',
        'status': 200
    }
    funcion = 'f5100_buscar_detalle_ts328'
...
@auth_decorator()
def f5400_buscar_caja_ts328():
    result = {
        'mensaje': 'Procesado correctamente',
        'status': 200
    }
    funcion = 'f5400_buscar_caja_ts328'
...
@auth_decorator()
def f6050_parametros_iniciales_ts328():
    result = {
        'mensaje': 'Procesado correctamente',
        'status': 200
    }
    funcion = 'f6050_parametros_iniciales_ts328'
...
@auth_decorator()
def f6050_reglas_negocio_ts328():
    result = {
        'mensaje': 'Procesado correctamente',
        'status': 200
    }
...
@auth_decorator()
def f6050_flujo_caja_ts328():
    result = {
        'mensaje': 'Procesado correctamente',
        'status': 200
    }
    funcion = 'f6050_flujo_caja_ts328'
...
@auth_decorator()
def f6050_parametros_control_ts328():
    result = {
        'mensaje': 'Procesado correctamente',
        'status': 200
    }
    funcion = 'f6050_parametros_control_ts328'
...
@auth_decorator()
def f6050_parametros_contabilidad_ts328():
    result = {
        'mensaje': 'Procesado correctamente',
        'status': 200
    }
...
@auth_decorator()
def f0400_proceso_cheques_ts328():
    result = {
        'mensaje': 'Procesado correctamente',
        'status': 200
    }
    funcion = 'f0400_proceso_cheques_ts328'
...
@auth_decorator()
def f6300_transacciones_caja_ts328():
    result = {
        'mensaje': 'Procesado correctamente',
        'status': 200
    }
    funcion = 'f6300_transacciones_caja_ts328'
